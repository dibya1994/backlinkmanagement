@include("contentcreator.include.header");
@include("contentcreator.include.sidebar");
@php
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('/contentcreator/package') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
...
@include("contentcreator.include.footer");
<script>
