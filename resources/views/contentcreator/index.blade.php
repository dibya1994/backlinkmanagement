...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Management Software - Content Creator Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Conetent Creator Panel" name="description" />
    <!-- App favicon -->
...
<body>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted" style="color: navy !important;font-size: 18px;font-weight: 500;">Content Creator Panel</p>
                                </div>
    ...
    @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="POST" action="{{ url('/contentcreator/login') }}">
                                        @csrf
                                        <div class="mb-3">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                2023 Management Software. Design & Developed by <i class="mdi mdi-heart text-danger"></i> by <a href="javascript:void(0)" target="_blank">Dibya</a>
                            </p>
                        </div>
                    </div>
                </div>
