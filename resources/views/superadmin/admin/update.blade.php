    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/superadmin/admin/'.$admin->id)}}" method="POST" enctype="multipart/form-data">
                                    {{ method_field('PATCH') }}
                                    @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="tel" class="form-control" name="phone" placeholder="Enter Phone" value="{{ $admin->phone }}"  pattern="[0-9]{3}[0-9]{3}[0-9]{4}" onkeypress="if(this.value.length==10) return false;"  required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-6">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <input type="hidden" name="previous_password" value="{{ $admin->password }}" >
