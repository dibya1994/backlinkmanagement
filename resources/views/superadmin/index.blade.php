...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Management Software - Super Admin Panel</title>
...
<body>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted" style="color: navy !important;font-size: 18px;font-weight: 500;">Super Admin Panel</p>
                                </div>
    ...
    @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="POST" action="{{ url('/superadmin/login') }}">
                                        @csrf
                                        <div class="mb-3">
