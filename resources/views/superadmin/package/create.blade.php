    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/superadmin/package') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="duration" placeholder="Duration (in Days)" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="user_limit" placeholder="User's Limit" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Maximum No of Projects*</label>
                                            <input type="number" class="form-control" name="max_project" placeholder="Maximum No of Projects" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
