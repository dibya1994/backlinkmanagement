...
<div class="main-content">
    ...
    <h4 class="card-title mb-0 flex-grow-1">Update Privacy Policy</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/superadmin/privacypolicy/'.$privacypolicy->id)}}" method="POST" enctype="multipart/form-data">
                                    {{ method_field('PATCH') }}
                                    @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-12 col-md-12">
                                            <div>
                                                ...
                                                <textarea id="editor" class="form-control" name="description" required> {{ $privacypolicy->description }} </textarea>
                                            </div>
                                        </div>
